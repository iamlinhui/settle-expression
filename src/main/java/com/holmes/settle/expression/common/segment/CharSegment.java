package com.holmes.settle.expression.common.segment;
...
public class CharSegment implements Segment, Cloneable {
    ...
    public Segment add(String key, Object v) {
        ...
        if (val == null) {
            ...
            List<Object> objSet = new LinkedList<>();
            objSet.add(val);
            objSet.add(v);
    ...
    public Segment born() {
        return new CharSegment(this.getOriginalString());
    }
    ...
    public List<Object> values() {
        List<Object> re = new ArrayList<>(nodes.size());
